                        ...
                        <div class="card-body">
                            <p class="d-inline-flex gap-1">
                                ...
                                <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#cсollapseExample" aria-expanded="false"
                                        aria-controls="collapseExample">
                                    Как доставить?
                                </button>
                                <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#cссollapseExample" aria-expanded="false"
                                        aria-controls="collapseExample">
                                    Какая гарантия?
                                </button>
                            </p>
                            ...
                            <div class="collapse" id="cсollapseExample">
                                <div class="card card-body">
                                    Поездом
                                </div>
                            </div>
                            <div class="collapse" id="cссollapseExample">
                                <div class="card card-body">
                                    Долгая
                                </div>
                            </div>
